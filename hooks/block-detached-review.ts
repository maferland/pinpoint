...
// Strip quoted spans so `pinpoint review` inside a string argument (release
// notes, commit messages) doesn't count. Replace `&&` / `||` with whitespace
// so only standalone backgrounding `&` survives.
